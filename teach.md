...
子代理是另一个独立工作的 agent。主 agent 给它一个明确目标、边界和期望结果；子代理带着自己的上下文和工具，专门完成这块工作，最后把结果交回主 agent。
...
Kitty 为子代理启动独立的 agent 循环。子代理完成后，结果回到主 agent，再由主 agent 完成整个任务。
