...
test("project map exposes stable project facts without semantic judgment", async (t) => {
  ...
  assert.ok(map.specDocuments.some((entry) => entry.includes("核心.md")));
