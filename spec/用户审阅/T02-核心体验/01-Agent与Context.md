...
Session memory 正文使用固定 Markdown 区块：`Current Objective`、`User Constraints`、`Decisions`、`Open Threads`、`Verification Facts`、`Reusable Lessons`。区块格式由机器提供，区块内容由模型根据事实写出。
