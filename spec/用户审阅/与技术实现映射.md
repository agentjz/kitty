...
| provider/model/relay/usage/cache 是模型连接主干 | `spec/技术实现/T05-Provider与模型/README.md` |
| init / doctor 是首次成功体验 | `spec/技术实现/T06-配置初始化诊断/README.md` |
...
| TUI 和 Web 只是 UI 壳 | `spec/技术实现/T08-TUI与RuntimeUI/README.md` |
