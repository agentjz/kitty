...
export const EVALUATION_SCENARIOS: readonly EvaluationScenario[] = [
  ...
  {
    id: "background-lifecycle-ready",
    suite: "local",
    title: "后台生命周期可见",
    userPath: "用户把长命令放到后台后，可以读取输出、等待或终止执行。",
    evidence: "构造 background execution，验证 output read、cancel wake 和 runtime status active/recent 投影。",
  },
  {
  ...
  },
  {
    ...
    suite: "local",
    title: "后台执行可恢复",
    userPath: "background 卡住、消失或超时后，Kitty 能 reconcile 或终止现场。",
    evidence: "演练 lost background、running process termination 和 runtime status。",
  },
];
