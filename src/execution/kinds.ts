...
export const EXECUTION_KINDS = ["background", "subagent", "team"] as const;
export type ExecutionKind = (typeof EXECUTION_KINDS)[number];

export const AGENT_WORKER_EXECUTION_KINDS = ["subagent", "team"] as const satisfies readonly ExecutionKind[];
...
export function toAgentWorkerIdentityKind(kind: AgentWorkerExecutionKind): AgentIdentity["kind"] {
  return kind === "team" ? "teammate" : "subagent";
}
